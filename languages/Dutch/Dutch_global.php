...
define("BIRTHDAY_LAN_0", "Iedereen die vandaag jarig is', gefeliciteerd!");
define("BIRTHDAY_LAN_1", "1 verjaardag vandaag, gefeliciteerd!");
define("BIRTHDAY_LAN_2", "");
define("BIRTHDAY_LAN_3", "Verjaardagen ");
define("BIRTHDAY_LAN_4", "Verjaardagen");
define("BIRTHDAY_LAN_5", "Volgende verjaardag:");
define("BIRTHDAY_LAN_6", "Geen verjaardag vandaag");

define("BIRTHDAY_ADMIN_A1","Verjaardagen Administratie");
define("BIRTHDAY_ADMIN_A2","Aantal verjaardagen om te laten zien");
define("BIRTHDAY_ADMIN_A3","Sla op");
define("BIRTHDAY_ADMIN_A4","Datum in dd/mm formaat");
define("BIRTHDAY_ADMIN_A5","Voorkeuren opgeslagen");
define("BIRTHDAY_ADMIN_A6","Verder");
